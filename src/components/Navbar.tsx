  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between">
        <Link to="/" className="text-xl md:text-2xl font-serif-display italic font-semibold text-portfolio-navy">
          Portfolio
        </Link>
      ...
      <div
        className={cn(
          'fixed inset-0 bg-portfolio-cream bg-opacity-95 z-40 md:hidden transition-transform duration-300 transform flex flex-col items-center justify-center',
