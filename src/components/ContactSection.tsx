        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <Card className="p-8 border-portfolio-mauve/20 rounded-2xl shadow-lg bg-gradient-to-br from-white to-portfolio-cream/30">
              <h3 className="font-serif-display italic text-2xl mb-6 text-portfolio-navy">Send Me a Message</h3>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-portfolio-navy">Name</Label>
                    <Input 
                      id="name" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-portfolio-navy">Email</Label>
                    <Input 
                      id="email" 
                      type="email" 
                ...
                <div className="space-y-2">
                  <Label htmlFor="subject" className="text-portfolio-navy">Subject</Label>
                  <Input 
                    id="subject" 
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-portfolio-navy">Message</Label>
                  <Textarea 
                    id="message" 
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="font-serif-display italic text-2xl mb-4 text-portfolio-navy">Let's Connect</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:your.email@example.com" className="text-portfolio-navy hover:text-portfolio-purple">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-portfolio-navy/60">Phone</p>
                  <a href="tel:+1234567890" className="text-portfolio-navy hover:text-portfolio-purple">
                    +1 (234) 567-890
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-portfolio-navy">San Francisco, CA</span>
                </div>
              </div>
            </div>
            
            <div className="mt-auto">
              <h4 className="text-lg font-medium mb-3 text-portfolio-navy">Connect With Me</h4>
              <div className="flex gap-4">
                ...
                <a 
                  ...
                  aria-label="Twitter"
                >
                  <Twitter size={20} className="text-portfolio-navy" />
                </a>
              </div>
            </div>
          </div>
